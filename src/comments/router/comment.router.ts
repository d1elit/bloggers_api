...
commentsRouter
    ...
    .delete('/:id', idValidation ,AccsessTokenGuardMiddleware,inputValidationResultMiddleware, deleteCommentHandler)
    .get('', getCommentListHandler)
    .put('/:id', AccsessTokenGuardMiddleware,commentInputDtoValidation ,inputValidationResultMiddleware, updateCommentHandler)